...
f5salvar_fcn=['switch v5promon;'...
    'case 0;'...
        ...
        'if v5savesignal==v5numsig;'...
            'msgbox(''Deve-se selecionar um unico sinal'',''Erro de definiï¿½ï¿½o'',''warn'');'...
            'return;'...
        'end;'...
...
f5sair_fcn=['v5sairqtn=questdlg(''Deseja fechar o modulo?'',''Sair'',''Sim'',''Nï¿½o'',''Sim'');'...
...
h5substituiropt=uicontrol('style','checkbox',...
    ...
    'FontWeight','bold',...
    'enable','off',...
    'string','Substituiï¿½ï¿½o de intervalos',...
...
h5frequencias=uicontrol('style','text',...
    ...
    'HorizontalAlignment','left',...
    'backgroundcolor',[0.93 0.93 0.93],...
    'string','Definiï¿½ï¿½o de freqï¿½ï¿½ncias [Hz]');
        ...
        'switch get(h5intaptxt,''value'');'...
            ...
            'case 2;'...
                ...
                'if v5teditminvalue<0;'...
                    ...
                    'msgbox(''O tempo inicial deve ser positivo'',''Erro de definiï¿½ï¿½o'',''warn'');'...
                    'return;'...
                'end;'...
                'if v5teditmaxvalue>str2num(v5treg);'...
                    'set(h5tfinaledit,''string'',num2str(v5tfinalok));'...
                    'msgbox(''O tempo final deve ser menor que o tempo de registro'',''Erro de definiï¿½ï¿½o'',''warn'');'...
                    'return;'...
                'end;'...
                'if v5teditminvalue>v5teditmaxvalue;'...
                    'set(h5tiniedit,''string'',num2str(v5tiniok));'...
                    'set(h5tfinaledit,''string'',num2str(v5tfinalok));'...
                    'msgbox(''O tempo final deve ser menor que o tempo inicial'',''Erro de definiï¿½ï¿½o'',''warn'');'...
                    'return;'...
                'end;'...
          ...
          'switch get(h5substituiropt,''value'');'...
                ...
                'case 0;'...
                    ...
                    'if v5feditminvalue<0;'...
                        ...
                        'msgbox(''A frequencia minima deve ser positiva'',''Erro de definiï¿½ï¿½o'',''warn'');'...
                        'delete(h5msnedit);'...
                        'return;'...
                    'end;'...
                    'if v5feditminvalue>fs/2;'...
                        'set(h5fminedit,''string'',num2str(v5fminok));'...
                        'msgbox(''A frequencia minima deve ser menor que fs/2'',''Erro de definiï¿½ï¿½o'',''warn'');'...
                        'delete(h5msnedit);'...
                        'return;'...
                    'end;'...
                    'if v5feditmaxvalue>fs/2;'...
                        'set(h5fmaxedit,''string'',num2str(v5fmaxok));'...
                        'msgbox(''A frequencia maxima deve ser menor que fs/2'',''Erro de definiï¿½ï¿½o'',''warn'');'...
                        'delete(h5msnedit);'...
                        'return;'...
                    'end;'...
                    'if v5feditmaxvalue<0;'...
                        'set(h5fmaxedit,''string'',num2str(v5fmaxok));'...
                        'msgbox(''A frequencia maxima deve ser positiva'',''Erro de definiï¿½ï¿½o'',''warn'');'...
                        'delete(h5msnedit);'...
                        'return;'...
                    'end;'...
                    'if v5feditminvalue>v5feditmaxvalue;'...
                        'set(h5fmaxedit,''string'',num2str(v5fmaxok));'...
                        'set(h5fminedit,''string'',num2str(v5fminok));'...
                        'msgbox(''A frequencia minima deve ser menor que a maxima'',''Erro de definiï¿½ï¿½o'',''warn'');'...
                        'delete(h5msnedit);'...
                        'return;'...
                    'end;'...
...
f5reset_fcn=['v5resetqtn=questdlg(''Deseja reiniciar o modulo?'',''Reiniciar'',''Sim'',''Nï¿½o'',''Sim'');'...
