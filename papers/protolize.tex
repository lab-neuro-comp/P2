...
$Protolize!$ also allows an integration with EEGLAB using the Studies Tool (Fig. 9). It contains the following options:
\begin{itemize}
\item Write about it;
\item Thank you.
\end{itemize}
